...
class Participant(Base):
    ...
    # foreign ids
    delegation_id = Column(String, ForeignKey("delegations.delegation_id"))
...
class SpeakerList(Base):
    ...
    # id
    speakerlist_id = Column(String, primary_key=True, index=True)
...
class SpeakerListEntry(Base):
    ...
    # id
    speakerlistentry_id = Column(String, primary_key=True, index=True)

    # foreign ids
    speakerlist_id = Column(String, ForeignKey("speakerlists.speakerlist_id"))
